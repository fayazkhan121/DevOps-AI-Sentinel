...
export default function DashboardView() {
  ...
  const renderWidget = (widget: DashboardWidget) => {
    switch (widget.type) {
      ...
      case "chart":
        return <div className="p-4 bg-white rounded-lg">Chart Widget (Coming Soon)</div>;
      case "status":
        return <div className="p-4 bg-white rounded-lg">Status Widget (Coming Soon)</div>;
      case "integration":
        return <div className="p-4 bg-white rounded-lg">Integration Widget (Coming Soon)</div>;
      default:
        return null;
    }
  };
